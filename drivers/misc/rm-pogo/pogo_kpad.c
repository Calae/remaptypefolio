...
static const uint32_t pogo_keymap_proto3[] = {
	...
	KEY(13, 2, KEY_SPACE),
	KEY(13, 3, KEY_BACKSLASH),
	KEY(13, 4, KEY_RIGHTBRACE),
	KEY(13, 5, KEY_LEFTBRACE),
	KEY(13, 6, KEY_M),
	KEY(13, 7, KEY_APOSTROPHE),
